...
const AdminModalNoParticipants = (props) => {
  ...
  var myTable = () => {
    ...
    var clickOnTitle = () => {
      var newArray = [...props.noParticipantsArray];
    ...
    var noParticipants;
      if (array.length > 0) {
        ...
        noParticipants = props.noParticipantsArray
      }

      var noParticipantsTable = noParticipants.map((element, i) => {
        return (
          <tr>
...
export default AdminModalNoParticipants ;